...
from django.conf.global_settings import MEDIA_URL, MEDIA_ROOT, STATICFILES_DIRS, EMAIL_HOST, EMAIL_HOST_USER, \
    EMAIL_HOST_PASSWORD, EMAIL_PORT, EMAIL_USE_TLS, EMAIL_BACKEND
